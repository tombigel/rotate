 ...
 */
(function () {
    this.MooTools = {version:"1.4.1", build:"d1fb25710e3c5482a219ab9dc675a4e0ad2176b6"};
...
(function () {
    ...
    k.setDocument = function (x) {
        ...
        this.document = x;
        var z = x.documentElement, v = this.getUIDXML(z), p = m[v], B;
        if (p) {
            for (B in p) {
                this[B] = p[B];
            }
        ...
        q.removeChild(A);
        A = t = q = null;
        p.getAttribute = (p.isHTMLDocument && s) ? function (E, C) {
        ...
        p.hasAttribute = (z && this.isNativeCode(z.hasAttribute)) ? function (D, C) {
            return D.hasAttribute(C);
        } : function (D, C) {
            D = D.getAttributeNode(C);
            return !!(D && (D.specified || D.nodeValue));
        };
        p.contains = (z && this.isNativeCode(z.contains)) ? function (C, D) {
            return C.contains(D);
        } : (z && z.compareDocumentPosition) ? function (C, D) {
    ...
    var a = k.attributeGetters = {"class":function () {
...
var contains = {contains:function (a) {
...
var injectCombinator = function (d, c) {
    if (!d) {
        return c;
    }
    d = Object.clone(Slick.parse(d));
    var b = d.expressions;
...
Object.forEach({getNext:"~", getPrevious:"!~", getParent:"!"}, function (a, b) {
    Element.implement(b, function (c) {
        return this.getElement(injectCombinator(c, a));
    });
});
Object.forEach({getAllNext:"~", getAllPrevious:"!~", getSiblings:"~~", getChildren:">", getParents:"!"}, function (a, b) {
    Element.implement(b, function (c) {
        return this.getElements(injectCombinator(c, a));
    });
});
Element.implement({getFirst:function (a) {
...
(function () {
    var b = {before:function (n, m) {
        ...
        var o = m.parentNode;
        if (o) {
            o.insertBefore(n, m.nextSibling);
        }
    }, bottom:function (n, m) {
        m.appendChild(n);
    }, top:function (n, m) {
    ...
    b.inside = b.bottom;
    Object.each(b, function (n, o) {
        o = o.capitalize();
        var m = {};
        m["inject" + o] = function (p) {
            n(this, document.id(p, true));
            return this;
        };
        m["grab" + o] = function (p) {
            n(document.id(p, true), this);
            return this;
        };
        Element.implement(m);
    });
    var k = {}, d = {};
    var i = {};
    Array.forEach(["type", "value", "defaultValue", "accessKey", "cellPadding", "cellSpacing", "colSpan", "frameBorder", "readOnly", "rowSpan", "tabIndex", "useMap"], function (m) {
        i[m.toLowerCase()] = m;
    });
    Object.append(i, {html:"innerHTML", text:(function () {
        var m = document.createElement("div");
        return(m.textContent == null) ? "innerText" : "textContent";
    })()});
    Object.forEach(i, function (n, m) {
        d[m] = function (o, p) {
            o[n] = p;
        };
        k[m] = function (o) {
    ...
    Object.append(d, {"class":function (m, n) {
        ("className" in m) ? m.className = n : m.setAttribute("class", n);
    }, "for":function (m, n) {
        ("htmlFor" in m) ? m.htmlFor = n : m.setAttribute("for", n);
    }, style:function (m, n) {
        (m.style) ? m.style.cssText = n : m.setAttribute("style", n);
    }});
    Element.implement({setProperty:function (n, o) {
        var m = n.toLowerCase();
        if (o == null) {
            if (!h[m]) {
        ...
        var n = k[o.toLowerCase()];
        if (n) {
            return n(this);
        }
        var m = Slick.getAttribute(this, o);
        return(!m && !Slick.hasAttribute(this, o)) ? null : m;
    }, getProperties:function () {
        var m = Array.from(arguments);
        return m.map(this.getProperty, this).associate(m);
    }, removeProperty:function (m) {
        return this.setProperty(m, null);
    }, removeProperties:function () {
        Array.each(arguments, this.removeProperty, this);
        return this;
    }, set:function (o, n) {
        var m = Element.Properties[o];
        (m && m.set) ? m.set.call(this, n) : this.setProperty(o, n);
    }.overloadSetter(), get:function (n) {
        var m = Element.Properties[n];
        return(m && m.get) ? m.get.apply(this) : this.getProperty(n);
    }.overloadGetter(), erase:function (n) {
        var m = Element.Properties[n];
        (m && m.erase) ? m.erase.apply(this) : this.removeProperty(n);
        return this;
    }, hasClass:function (m) {
        return this.className.clean().contains(m, " ");
    }, addClass:function (m) {
        if (!this.hasClass(m)) {
        ...
        return this;
    }, toggleClass:function (m, n) {
        if (n == null) {
            n = !this.hasClass(m);
        }
        return(n) ? this.addClass(m) : this.removeClass(m);
    }, adopt:function () {
        var p = this, m, r = Array.flatten(arguments), q = r.length;
        if (q > 1) {
            p = m = document.createDocumentFragment();
        }
        for (var o = 0; o < q; o++) {
            var n = document.id(r[o], true);
            if (n) {
                p.appendChild(n);
            }
        }
        ...
        b[m || "bottom"](document.id(n, true), this);
        return this;
    }, inject:function (n, m) {
        b[m || "bottom"](this, document.id(n, true));
        return this;
    }, replaces:function (m) {
        ...
        this.selectedIndex;
        return new Elements(Array.from(this.options).filter(function (m) {
            return m.selected;
        }));
    }, toQueryString:function () {
        var m = [];
        this.getElements("input, select, textarea").each(function (o) {
            var n = o.type;
            if (!o.name || o.disabled || n == "submit" || n == "reset" || n == "file" || n == "image") {
                return;
            }
            var p = (o.get("tag") == "select") ? o.getSelected().map(function (q) {
                return document.id(q).get("value");
            }) : ((n == "radio" || n == "checkbox") && !o.checked) ? null : o.get("value");
            Array.from(p).each(function (q) {
                if (typeof q != "undefined") {
                    m.push(encodeURIComponent(o.name) + "=" + encodeURIComponent(q));
                }
            });
        });
        return m.join("&");
    ...
    Element.implement({destroy:function () {
        var m = g(this).getElementsByTagName("*");
        Array.each(m, g);
        ...
        if (r) {
            o.append(Array.from(w.getElementsByTagName("*")));
            q.append(Array.from(this.getElementsByTagName("*")));
        }
        for (u = o.length; u--;) {
            var s = o[u], v = q[u];
            if (!p) {
            ...
            if (s.clearAttributes) {
                ...
                if (s.options) {
                    var z = s.options, m = v.options;
                    for (var t = z.length; t--;
                        ) {
                        z[t].selected = m[t].selected;
                    }
                }
            }
            var n = l[v.tagName.toLowerCase()];
            if (n && v[n]) {
                s[n] = v[n];
            }
        }
        if (Browser.ie) {
            var x = w.getElementsByTagName("object"), y = this.getElementsByTagName("object");
            for (u = x.length; u--;) {
    ...
    [Element, Window, Document].invoke("implement", {addListener:function (p, o) {
        if (p == "unload") {
            var m = o, n = this;
            o = function () {
        ...
        if (this.addEventListener) {
            this.addEventListener(p, o, !!arguments[2]);
        } else {
        ...
        if (this.removeEventListener) {
            this.removeEventListener(n, m, !!arguments[2]);
        } else {
            this.detachEvent("on" + n, m);
        }
        return this;
    }, retrieve:function (n, m) {
        var p = c($uid(this)), o = p[n];
        if (m != null && o == null) {
            o = p[n] = m;
        }
    ...
    Element.Properties.style = {set:function (m) {
        this.style.cssText = m;
    }, get:function () {
    ...
    Element.Properties.html = (function () {
        ...
        o.thead = o.tfoot = o.tbody;
        t.innerHTML = "<nav></nav>";
        var n = t.childNodes.length == 1;
        if (!n) {
            var q = "abbr article aside audio canvas datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video".split(" "), p = document.createDocumentFragment(), m = q.length;
            while (m--) {
                p.createElement(q[m]);
            }
            p.appendChild(t);
        }
        var r = {set:function (v) {
            if (typeOf(v) == "array") {
                v = v.join("");
            }
            var w = (!s && o[this.get("tag")]);
            if (!w && !n) {
                w = [0, "", ""];
            }
            if (w) {
                var x = t;
                x.innerHTML = w[1] + v + w[2];
                for (var u = w[0]; u--;) {
                    x = x.firstChild;
                }
                this.empty().adopt(x.childNodes);
            } else {
                this.innerHTML = v;
            }
        }};
    ...
    f.innerHTML = "<select><option>s</option></select>";
    if (f.firstChild.value != "s") {
        Element.Properties.value = {set:function (r) {
            var n = this.get("tag");
            if (n != "select") {
                return this.setProperty("value", r);
            }
            var o = this.getElements("option");
            for (var p = 0; p < o.length; p++) {
                var q = o[p], m = q.getAttributeNode("value"), s = (m && m.specified) ? q.value : q.get("text");
                if (s == r) {
                    return q.selected = true;
                }
            }
        }, get:function () {
            var o = this, n = o.get("tag");
            if (n != "select" && n != "option") {
                return this.getProperty("value");
            }
            if (n == "select" && !(o = o.getSelected()[0])) {
                return"";
            }
            var m = o.getAttributeNode("value");
...
(function () {
    var f = document.html;
    Element.Properties.styles = {set:function (i) {
        this.setStyles(i);
    }};
    var h = (f.style.opacity != null), a = (f.style.filter != null), g = /alpha\(opacity=([\d.]+)\)/i;
    var b = function (j, i) {
        j.store("$opacity", i);
        j.style.visibility = i > 0 ? "visible" : "hidden";
    };
    var d = (h ? function (j, i) {
        j.style.opacity = i;
    } : (a ? function (j, i) {
    ...
    var e = (h ? function (j) {
        ...
        var k = (j.style.filter || j.getComputedStyle("filter")), i;
        if (k) {
            i = k.match(g);
        }
    ...
    Element.implement({getComputedStyle:function (k) {
        if (this.currentStyle) {
            return this.currentStyle[k.camelCase()];
        }
        var j = Element.getDocument(this).defaultView, i = j ? j.getComputedStyle(this, null) : null;
        ...
        if (Browser.opera || (Browser.ie && isNaN(parseFloat(i)))) {
            if ((/^(height|width)$/).test(o)) {
                var j = (o == "width") ? ["left", "right"] : ["top", "bottom"], l = 0;
                j.each(function (p) {
    ...
    Element.implement({setOpacity:function (i) {
        d(this, i);
        return this;
    }, getOpacity:function () {
        return e(this);
    }});
    Element.Properties.opacity = {set:function (i) {
        d(this, i);
        b(this, i);
    }, get:function () {
        return e(this);
    ...
    ["Top", "Right", "Bottom", "Left"].each(function (o) {
        ...
        var l = m + "Width", i = m + "Style", k = m + "Color";
        n[m] = {};
